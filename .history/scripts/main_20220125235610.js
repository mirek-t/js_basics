...
//obiekt jako zdestrukturyzowany argument funkcji
...
const changeX = (z) => {
  ...
  console.log(po); // w tej zmiennej jest nazwa pokemona
...
const getPokemon = (name) =>{
  ...
  const result = fetch(url).then(result => result.json()).then(result => changeX(result.thumble));
  
};

getPokemon(51); //nie działa w terminalu programu, odpal przez przeglądarkę.



['10', '10', '10'].map(parseInt);// wynik: [10,NaN, 2]
